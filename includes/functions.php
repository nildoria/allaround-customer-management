...
function woocommerce_header_add_to_cart_fragment_checkout( $fragments ) {
    ...
    echo '<div class="alarnd-checkout-wrap-inner">';
        ...
        <!-- Card Image Demo -->
        <div class="no-token-payment-info-display">
            <div class="payment-title">
                <h3><?php esc_html_e("Payment Information", "allaroundminilng" ); ?></h3>
            </div>
...
function allaround_card_form($user_id = null) {
    ...
    ?>
    <form action="" id="cardDetailsForm" class="allaround--card-form">


        <div class="form-row">
            <div class="form-label"><?php esc_html_e("Cardholder's Name", "allaroundminilng" ); ?>:</div>
        ...
        <div class="form-row">
            <div class="form-label"><?php esc_html_e("Cardholder's Phone", "allaroundminilng" ); ?>:</div>
            <div class="form-input">
        ...
        <div class="form-row">
            <div class="form-label"><?php esc_html_e("Cardholder's Email", "allaroundminilng" ); ?>:</div>
            <div class="form-input">
        ...
        <div class="form-row">
            <div class="form-label"><?php esc_html_e("Cardholder's Address", "allaroundminilng" ); ?>:</div>
            <div class="form-input">
        ...
        <div class="form-row">
            ...
            <div class="form-input">
                <input type="text" pattern="[0-9]*" inputmode="numeric" id="cardNumber" name="cardNumber" placeholder="<?php esc_attr_e("required", "allaroundminilng" ); ?>" required>
        ...
        <div class="form-row flex-row">
            <div class="form-row">
                ...
                <div class="form-input">
                    <input type="text" pattern="[0-9]*" inputmode="numeric" id="expirationDate" name="expirationDate" placeholder="<?php esc_attr_e("MM/YY", "allaroundminilng" ); ?>" required>
                </div>
            </div>
            <div class="form-row">
