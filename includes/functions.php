    ...
    <form action="" id="customerDetails" class="allaround--card-form">
        <div class="form-row flex-row">
            ...
            <div class="form-row">
                <div class="form-label"><?php esc_html_e("Invoice Name", "allaroundminilng" ); ?>:</div>
                <div class="form-input">
                    <input type="text" id="userInvoiceName" name="userInvoiceName" placeholder="<?php esc_attr_e("required", "allaroundminilng" ); ?>" value="" required>
                </div>
            </div>
        </div>
        <div class="form-row">
        ...
        <div class="form-row flex-row">
            ...
            <div class="form-row">
                <div class="form-label"><?php esc_html_e("City", "allaroundminilng" ); ?>:</div>
                <div class="form-input">
                    <input type="text" id="userCity" name="userCity" placeholder="<?php esc_attr_e("required", "allaroundminilng" ); ?>" value="" required>
                </div>
            </div>
        </div>
        <div class="form-row">
