...
class ML_Ajax
{
    ...
    public function ml_pagination()
    {
        ...
        // Get All selected product IDs for the user
                ...
                <div class="alarnd--modal-inner alarnd--modal-chart-info">
                    ...
                    <form class="modal-cart" action="" enctype='multipart/form-data'>
                        ...
                        <div class="alarnd--single-button-wrap">
                            ...
                            <button type="submit" name="add-to-cart" value="<?php echo esc_attr($product->get_id()); ?>"
                                class="single_add_to_cart_button button alt ml_add_loading ml_quantity_product_addtocart"><?php echo esc_html($product->single_add_to_cart_text()); ?></button>
                        </div>
